...
public class CategoryFilterPage extends BasePage {
    ...
    private String CATEGORY_DROPDOWN = "xpath=>//div[contains(@class,'pull-left course-filter')][1]//button";
    ...
    public ResultsPage select(String categoryName) {
        ...
        //Used JavaScript click because this element was having issues wth usual click method
