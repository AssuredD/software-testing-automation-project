...
public class Constants {
    ...
    public static final String TESTER_NAME = "Kaiser N";
    public static final String DEFAULT_USERNAME = "asidcam@gmail.com";
    public static final String DEFAULT_PASSWORD = "246//Asid";
